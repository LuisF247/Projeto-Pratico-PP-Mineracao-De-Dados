...
*   **Modelagem e Machine Learning - Leonardo Santos:** Responsável por treinar e testar os modelos de previsão de preço (notebook `03-modelagem.ipynb`).
*   **Avaliação e Conclusão - Luís Fernando:** Responsável por avaliar a performance dos modelos, interpretar os resultados e redigir a conclusão do projeto (notebook `04-avaliacao-e-resultados.ipynb`).
