...
*   **Avaliação e Conclusão - Luis Fernando Ferreira:** Responsável por avaliar a performance dos modelos, interpretar os resultados e redigir a conclusão do projeto (notebook `04-avaliacao-e-resultados.ipynb`).
